#!/usr/bin/env python3
"""Split a monolithic style_guide.css into styles/style-guide/*.css parts.

NOTE: 04a–04c and 05a–05b are maintained manually; this script must not
overwrite those files. Summerschool uses summerschool/css/ss-*.css shards.
"""
...
def main() -> None:
    ...
    for name, start, end, desc in CHUNKS:
        ...
        header = [
            ...
            f"   {desc}",
            "   Part of style_guide.css split — see docs/guides/style_guide.md §CSS Architecture",
            "   ========================================================================== */",
            "",
        ]
    ...
    hub = [
        ...
        "   See docs/guides/style_guide.md §CSS Architecture for file map & edit routing.",
        "   ========================================================================== */",
        "",
    ]
