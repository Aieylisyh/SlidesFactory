...
说明文档：[`guides/REMOTE_GUIDE.md`](REMOTE_GUIDE.md) · 互动焦点：[`guides/REMOTE_FOCUS_MAP.md`](REMOTE_FOCUS_MAP.md)
...
| `slides[].title` | 来自 `share-pages.json` |
| `chapters[]` | 来自 [`../outline.md`](../outline.md) 议程表 |
...
- **零侵入**：不改 `index.html`、`scripts/main.js`
