...
本目录集中存放 SFK 幻灯片工坊的**规范与说明**类 Markdown。运行时入口（`index.html`、`outline.md`）与 co-located README（`contents/`、`styles/style-guide/` 等）仍保留在原目录。
...
| [OUTLINE_GUIDE.md](OUTLINE_GUIDE.md) | 根目录 [`outline.md`](../outline.md) 编写约定 |
...
| 文档 | 用途 |
|------|------|
| [PORTRAIT_ADAPT_GUIDE.md](PORTRAIT_ADAPT_GUIDE.md) | 竖屏轻量适配（策略 A） |
| [WHEEL_NAV_GUIDE.md](WHEEL_NAV_GUIDE.md) | 滚轮双 tick 翻页 |
...
| 文档 | 用途 |
|------|------|
| [design-curriculum-foundation.md](design-curriculum-foundation.md) | 课程基础设计稿 |
| [design-salary-echarts.md](design-salary-echarts.md) | 薪资 ECharts 设计说明 |

## 相关（不在本目录）

| 路径 | 用途 |
|------|------|
| [`outline.md`](../outline.md) | 主 deck 页序与结构（内容源，非纯说明） |
