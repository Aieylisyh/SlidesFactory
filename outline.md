...
> **规范说明**：字段含义与模板见 [`guides/OUTLINE_GUIDE.md`](guides/OUTLINE_GUIDE.md)。
...
| `share_pages` | 全部 leaf 页已登记于 `share-pages.json`；链接格式 `index.html?share=<slug>`，详见 [`guides/SHARE_GUIDE.md`](guides/SHARE_GUIDE.md) |
...
|------|-----|
| `pages` | 9–12 |
| `assets` | `contents/*.pdf` → `python scripts/extract_pdf_images.py --pdf contents/<file>.pdf --out assets/pdf-extracted` → `python scripts/compress_web_assets.py` |
| `interactive` | 可选 `data-match-game` · `case-match.js` |
...
| `components` | 见 [`guides/style_guide_extended.md`](guides/style_guide_extended.md) §4、§6 |
...
| `layout` | 横向箭头时间轴 — 规范见 [`guides/segment_arrow.md`](guides/segment_arrow.md) |
| `interactive` | `data-segment-arrow` · `segment-arrow.js` |
