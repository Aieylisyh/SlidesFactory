...
CLI examples:
  ...
  python scripts/extract_pdf_images.py --pdf contents/case.pdf --out assets/pdf-extracted
  python scripts/extract_pdf_images.py --pdf contents/a.pdf --page 5
  python scripts/extract_pdf_images.py --pdf contents/a.pdf --page 3,5-7
  python scripts/extract_pdf_images.py --crop-existing --out assets/pdf-extracted
"""
import argparse
import io
import math
